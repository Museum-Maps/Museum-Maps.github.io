...
lyr_spatialanalysis_3.set('fieldLabels', {'X': 'header label - visible with data', 'Y': 'no label', 'Name': 'no label', 'addrln1': 'no label', 'city': 'no label', 'state': 'no label', 'tract': 'no label', 'income_per': 'no label', 'sup_dist': 'no label', 'csa': 'no label', 'spa': 'no label', 'ESRI_OID': 'no label', });
